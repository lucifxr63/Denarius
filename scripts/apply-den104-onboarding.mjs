...
const query=fs.readFileSync('supabase/migrations/20260807110000_actionable_financial_onboarding.sql','utf8')
...
if(!response.ok)throw new Error(`${response.status}: ${await response.text()}`);console.log('APPLIED DEN-104 actionable onboarding')
