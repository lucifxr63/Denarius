...
const query = fs.readFileSync(path.resolve('supabase/migrations/20260807020000_saas_subscriptions.sql'), 'utf8');
...
console.log('APPLIED E09 SaaS subscriptions migration');
