...
const query=fs.readFileSync('supabase/migrations/20260807100000_transaction_csv_import.sql','utf8')
...
console.log('APPLIED DEN-102/DEN-103 idempotent CSV import')
