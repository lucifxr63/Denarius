...
const query=fs.readFileSync('supabase/migrations/20260807140000_den105_financial_alert_center.sql','utf8')
...
if(!response.ok)throw new Error(`${response.status}: ${await response.text()}`);console.log('APPLIED DEN-105 financial alert center')
